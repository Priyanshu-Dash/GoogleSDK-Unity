...
namespace GoogleSignIn
{
    ...
    public class GoogleSignInManager : MonoBehaviour
    {
        ...
        /// <summary>
        /// Initialize Google Sign-In with server client ID (optional)
        /// </summary>
        /// <param name="serverClientId">Server client ID for backend authentication (optional)</param>
        public void Initialize(string serverClientId = null)
        {
#if UNITY_ANDROID && !UNITY_EDITOR
            GoogleSignInAndroid.Initialize(serverClientId);
